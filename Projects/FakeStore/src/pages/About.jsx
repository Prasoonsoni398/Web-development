    ...
    <main className="min-h-[95vh] bg-slate-100 pb-16">
      <section className="mx-auto max-w-6xl px-6 py-12 sm:px-10 sm:py-16">
        <div className="grid gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          <div className="space-y-6 rounded-4xl bg-white p-10 shadow-[0_40px_80px_rgba(15,23,42,0.08)]">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-[28px] bg-slate-50 p-6 text-center shadow-sm">
                <p className="text-3xl font-bold text-slate-900">150+</p>
                <p className="mt-2 text-sm uppercase tracking-[0.35em] text-slate-500">Products</p>
              </div>
              <div className="rounded-[28px] bg-slate-50 p-6 text-center shadow-sm">
                <p className="text-3xl font-bold text-slate-900">4.8</p>
                <p className="mt-2 text-sm uppercase tracking-[0.35em] text-slate-500">Avg rating</p>
              </div>
              <div className="rounded-[28px] bg-slate-50 p-6 text-center shadow-sm">
                <p className="text-3xl font-bold text-slate-900">24/7</p>
                <p className="mt-2 text-sm uppercase tracking-[0.35em] text-slate-500">Support</p>
              </div>
            </div>
          </div>
